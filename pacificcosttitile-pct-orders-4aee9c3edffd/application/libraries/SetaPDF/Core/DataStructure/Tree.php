 ...
 * @version    $Id: Tree.php 472 2013-05-22 08:57:15Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_DataStructure_Interface
{
     ...
     * @return bool|SetaPDF_Core_Type_Dictionary
     */
    protected function _findLastLeafNode(SetaPDF_Core_Type_Dictionary $node, &$intermediateNodes)
    {
     ...
     * given in $alreadyExistsCallback if an item already exists. This method can
     * take control over the re-naming of the item.
     * The method will be called as long as it will not throw an exception of
     * {@link SetaPDF_Core_DataStructure_Tree_KeyAlreadyExistsException}.
     *
     ...
     * @param null|callback $alreadyExistsCallback
                ...
                if (is_callable($alreadyExistsCallback)) {
                    ...
                    while (++$i) {
                        ...
                        try {
                            ...
                            SetaPDF_Core_DataStructure_Tree_KeyAlreadyExistsException $e
                        ) {
                        }
                        ;
                    }
     ...
     * @throws SetaPDF_Core_DataStructure_Tree_KeyAlreadyExistsException
     */
    public function add($key, SetaPDF_Core_Type_Abstract $value)
    {
