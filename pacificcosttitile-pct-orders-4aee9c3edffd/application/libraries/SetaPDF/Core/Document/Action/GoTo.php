 ...
 * @version    $Id: GoTo.php 434 2013-05-15 08:31:53Z jan.slabon $
 */
...
class SetaPDF_Core_Document_Action_GoTo extends SetaPDF_Core_Document_Action
{
     ...
     *
     * @param scalar|SetaPDF_Core_Type_Array|SetaPDF_Core_Type_Name|SetaPDF_Core_Type_String $destination
     ...
     * The constructor
     *
     * @param scalar|SetaPDF_Core_Type_Dictionary|SetaPDF_Core_Type_IndirectObjectInterface $objectOrDictionary
     * @throws InvalidArgumentException
     */
