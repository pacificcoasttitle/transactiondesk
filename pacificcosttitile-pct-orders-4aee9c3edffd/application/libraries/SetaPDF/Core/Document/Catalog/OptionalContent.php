 ...
 * @version    $Id: Outlines.php 298 2012-10-31 14:36:24Z maximilian $
 */
...
class SetaPDF_Core_Document_Catalog_OptionalContent implements IteratorAggregate
{
    ...
    /**
     * Get and/or creats an array entry in the default viewing dictionary
     * 
     * @param string $name
     * @param boolean $create
     ...
     * 
     * The usage defination in an optional content group will only apply to automatically
     ...
     * 
     * Returns an array of SetaPDF_Core_Document_OptionalContent_Group objects
     * 
     * @return array
     */
    ...
    /**
     * Implemenation of IteratorAggregate
     * 
