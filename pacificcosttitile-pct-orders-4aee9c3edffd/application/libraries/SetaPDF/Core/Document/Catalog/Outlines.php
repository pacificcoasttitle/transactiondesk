...
class SetaPDF_Core_Document_Catalog_Outlines implements IteratorAggregate, ArrayAccess
{
    ...
    /**
     * Get the iterator for the outlines
     * 
     * @see IteratorAggregate::getIterator()
     * @param boolean $recreate
     * @return EmptyIterator|RecursiveIteratorIterator
     */
     ...
     *
     * @param SetaPDF_Core_Document_OutlinesItem|SetaPDF_Core_Document_Outlines $item
     */
