 ...
 * @version    $Id: ZapfDingbats.php 378 2013-02-07 17:00:17Z jan $
 */
...
class SetaPDF_Core_Font_Standard_ZapfDingbats extends SetaPDF_Core_Font_Standard
{
     ...
     */
    static public function getDefaultDictionary($encoding = 'ZapfDingbats')
    {
    ...
    public function __construct(SetaPDF_Core_Type_IndirectObject $indirectObject)
    {
    	parent::__construct($indirectObject);
