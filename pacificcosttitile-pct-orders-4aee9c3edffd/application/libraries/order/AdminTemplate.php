...
class AdminTemplate
{
    ...
    public function show($folder, $page, $data=null)
    {
        if ( ! file_exists('application/modules/admin/views/'.$folder.'/'.$page.'.php' ) ) {
            ...
            $this->data['header'] = $this->CI->load->view('order/layout/newheader.php', $data, true);
            $this->data['sidebar'] = $this->CI->load->view('order/layout/newsidebar.php', $data, true);
            $this->data['content'] = $this->CI->load->view($folder.'/'.$page.'.php', $data, true);
            $this->data['footer'] = $this->CI->load->view('order/layout/newfooter.php', $data, true);
