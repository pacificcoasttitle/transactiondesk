     ...
     <div class="row">
      ...
      <!-- <div class="row"> -->
          ...
          <div class="col-md-12" id="importFrm" style="display: none;">
              <form action="<?php echo base_url(); ?>index.php?admin/import_escrow_resale" method="post" enctype="multipart/form-data">
          ...
          <!-- Data list table -->
          <table class="table table-striped table-bordered" id="tbl-escrow-resale-rates">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td><?php echo "$".number_format($row['min_rate']); ?></td>
                  </tr>
                  <?php } }else{ 
                   ?>
...
$( document ).ready(function() {
   ...
   $('.alert').delay(5000).fadeOut(300);
    ...
    if($('#tbl-escrow-resale-rates').length)
    {
        $('#tbl-escrow-resale-rates').DataTable({
           "pageLength": 20,
           "lengthChange": false,
           "searching": false,
           "language": {
