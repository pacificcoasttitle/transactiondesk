            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Add Memo</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" id="add_memo_form" name="add_memo_form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="subject">Subject<span class="required"> *</span></label>
                                        <input type="text" value="<?php echo set_value('subject')?>" class="form-control" placeholder="Subject" name="subject" id="subject" required="required">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo set_value('memo_date')?>" class="form-control" placeholder="Memo Date" name="memo_date" id="memo_date" value="" required="required">
                                    </div>
                                    <input type="hidden" id="memo_date_val" name="memo_date_val" value="<?php echo set_value('memo_date')?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="memo_description" name="memo_description" rows="15" required="required">
                                            <?php echo set_value('memo_description')?>
                                        </textarea>
