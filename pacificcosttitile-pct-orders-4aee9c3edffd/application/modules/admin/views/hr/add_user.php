                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="position" id="position" class="form-control" required>
                                            ...
                                            <?php foreach($hrPositions as $hrPosition) {?>
                                                <option value="<?php echo $hrPosition['id'];?>"><?php echo $hrPosition['name'];?></option>
                                            <?php } ?>
                                        </select> 
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Hire Date" name="hire_date" id="hire_date" value="" required="required">
                                    </div>
