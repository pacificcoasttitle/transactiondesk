        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" name="edit_department_form" >
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email">Department Name<span class="required"> *</span></label>
                                        <input type="text" value="<?php echo $departmentInfo['name'];?>" class="form-control" placeholder="User Type Name" name="department_name" id="department_name" required="required">
                                    </div>
