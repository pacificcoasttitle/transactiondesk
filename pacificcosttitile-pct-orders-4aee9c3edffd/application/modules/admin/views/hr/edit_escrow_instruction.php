            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Escrow Instruction</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" id="edit_escrow_instruction_form" name="edit_escrow_instruction_form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="escrow_instruction" id="escrow_instruction" class="form-control" required="required">
                                            ...
                                            <?php foreach($escrow_instruction_list as $escrow_instruction) {?>
                                                <option <?php echo ($escrow_instruction_data->escrow_instruction_id == $escrow_instruction->id) ? 'selected' : '';?> value="<?php echo $escrow_instruction->id;?>"><?php echo $escrow_instruction->name;?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $escrow_instruction_data->custom_field_value_id;?>" class="form-control" placeholder="Custom Field Value ID" name="custom_field_value_id" id="custom_field_value_id" required="required">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $escrow_instruction_data->custom_field_id;?>" class="form-control" placeholder="Custom Field ID" name="custom_field_id" id="custom_field_id" value="" required="required">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $escrow_instruction_data->name;?>" class="form-control" placeholder="Name" name="name" id="name"  required="required">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="escrow_instruction_value" name="escrow_instruction_value" rows="15" required="required">
                                            <?php echo $escrow_instruction_data->value;?>
                                        </textarea>
