        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" name="edit_position_form" >
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email">Position Name<span class="required"> *</span></label>
                                        <input type="text" value="<?php echo $positionInfo['name'];?>" class="form-control" placeholder="User Type Name" name="position_name" id="position_name" required="required">
                                    </div>
