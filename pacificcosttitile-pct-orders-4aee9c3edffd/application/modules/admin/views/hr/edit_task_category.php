        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" name="edit_task_category_form" >
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="category_name">Name<span class="required"> *</span></label>
                                        <input type="text" class="form-control" value="<?php echo $record->name;?>" placeholder="Category Name" name="category_name" id="category_name" required="required">
                                    </div>
							...
							<div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										<textarea class="form-control" placeholder="Category Description" name="category_description" id="category_description"><?php echo $record->description;?></textarea>
                                    </div>
