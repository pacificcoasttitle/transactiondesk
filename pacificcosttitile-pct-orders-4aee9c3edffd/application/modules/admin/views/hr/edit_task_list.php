        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" name="edit_task_list_form" >
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="task_name">Name<span class="required"> *</span></label>
                                        <input type="text" class="form-control" value="<?php echo $record->name;?>" placeholder="Task Name" name="task_name" id="task_name" required="required">
                                    </div>
							...
							<div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										<textarea class="form-control" placeholder="Task Description" name="task_description" id="task_description"><?php echo $record->description;?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
										...
										<select class="form-control" name="task_category" id="task_category" required>
											...
											<?php foreach($task_list_category as $category): ?>
												<option value="<?php echo $category->id;?>" <?php if($record->category_id == $category->id) echo 'selected';?>><?php echo $category->name; ?></option>
											<?php endforeach; ?>
										</select>
