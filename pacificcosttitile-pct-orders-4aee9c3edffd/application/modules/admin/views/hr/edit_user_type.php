        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" name="edit_user_type_form" >
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email">User Type Name<span class="required"> *</span></label>
                                        <input type="text" value="<?php echo $userTypeInfo['name'];?>" class="form-control" placeholder="User Type Name" name="user_type_name" id="user_type_name" required="required">
                                    </div>
