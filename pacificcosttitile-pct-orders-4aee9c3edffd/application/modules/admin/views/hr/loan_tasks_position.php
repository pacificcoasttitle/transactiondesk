...
<div class="content">
    <div class="container-fluid">
		...
		<form method="post" action="<?php echo base_url('hr/admin/save-loan-tasks-position');?>" id="loan_position_task_form" name="loan_position_task_form">
			<div class="row">
				<div class="col-md-12">
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Loan Tasks List</h6>
						</div>
