<div class="container-fluid">	
	...
	<div id="memos_success_msg" class="btn btn-success btn-block mt-1 mb-3" style="display:none;"></div>
	<div id="memos_error_msg" class="btn btn-danger btn-block mt-1 mb-3" style="display:none;"></div>

	<!-- DataTales Example -->
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Memos Listing</h6>
		</div>
		<div class="card-body">
			<div class="table-responsive">
				<table class="table table-bordered" id="memos" width="100%" cellspacing="0">
					<thead>
						<tr>
                            <th>No</th>
                            <th>Subject</th>
