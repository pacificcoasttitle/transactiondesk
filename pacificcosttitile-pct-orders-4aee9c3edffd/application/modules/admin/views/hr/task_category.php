<div class="container-fluid">	
	<div class="row mb-3">
		...
		<div class="col-sm-6">
            <a href="<?php echo base_url().'hr/admin/add-task-category'; ?>" class="btn btn-success btn-icon-split float-right">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Task Category Listing</h6>
		</div>
		<div class="card-body">
