<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Timecards Listing</h6>
		</div>
		<div class="card-body">
			<div class="table-responsive">
				<table class="table table-bordered" id="time_cards" width="100%" cellspacing="0">
					<thead>
						<tr>
							<th>No</th>
							<th>Employee</th>
...
<div class="modal fade" width="500px" id="timecard_deny_popup" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document" style="width:40%;">
		<div class="modal-content">
			<form method="POST" action="<?php echo base_url();?>hr/admin/approve-deny-request" enctype="multipart/form-data">
				<div class="row">
					<div class="col-lg-12">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary" >Deny Time Card Request Confirmation</h6>
							</div>
							<input type="hidden"  name="request_type" value="time_card">
