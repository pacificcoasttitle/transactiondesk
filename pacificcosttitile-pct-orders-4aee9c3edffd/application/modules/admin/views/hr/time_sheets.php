<div class="container-fluid">
	<div class="row mb-3">
		<div class="col-sm-6">
			<h1 class="h3 text-gray-800">Timesheets</h1>
		</div>
		<div class="col-sm-6">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Timesheet Listing</h6>
		</div>
		<div class="card-body">
			<div class="table-responsive">
				<table class="table table-bordered" id="commonAdminTbl" width="100%" cellspacing="0" data-url="<?php echo base_url('hr/admin/get-time-sheets');?>">
					<thead>
						<tr>
							<th>No</th>
							<th>Employee</th>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card shadow mb-4">
							...
							<input type="hidden" id="request_type" name="request_type" value="time_sheet_status">
...
<div class="modal fade" width="500px" id="timesheet_deny_popup" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document" style="width:40%;">
		<div class="modal-content">
			<form method="POST" action="<?php echo base_url();?>hr/admin/approve-deny-request" enctype="multipart/form-data">
				<div class="row">
					<div class="col-lg-12">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary" >Deny Request Confirmation</h6>
							</div>
							<input type="hidden"  name="request_type" value="time_sheet_status">
