...
<div class="container-fluid">
        <div class="row mb-3">
            <div class="col-sm-6">
                <h1 class="h3 text-gray-800">Edit Holiday</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card-body">
            <form id="frm-add-holiday" method="POST">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" value="<?php echo $holiday_info['name']; ?>" class="form-control" name="holiday_name" id="holiday_name" class="form-control" placeholder="Holiday Name">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" value="<?php echo date("m/d/Y", strtotime($holiday_info['holiday_date'])); ?>" name="holiday_date" id="holiday_date" class="form-control" placeholder="Holiday Date">
