			...
			<div class="col-md-12">
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Update Bonus Range</h6>
					</div>
					<div class="card-body">        
						<form id="frm-add-bonus-range" method="POST" >
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input  step="1" min="0"  type="number" class="form-control" name="revenue_range_min" id="revenue_range_min" class="form-control" placeholder="From revenue"  value="<?php echo set_value('revenue_range_min',$record->min_range) ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input  step="1" min="0"  type="number" class="form-control" name="bonus_amount" id="bonus_amount" class="form-control" placeholder="Enter Bonus Amout"  value="<?php echo set_value('bonus_amount',$record->bonus_amount) ?>">
