...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-sm-6">
                <h1 class="h3 text-gray-800">Edit Commission Range</h1>
            </div>
        </div>
        <div class="row">
			<div class="col-md-12">
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Edit Commission Range</h6>
					</div>
					<div class="card-body">        
						<form id="frm-add-commission-range" method="POST" >

						<div class="form-group">
							<label for="zipcode" class="col-sm-2 col-form-label">Product Type</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="zipcode" class="col-sm-2 col-form-label">Underwriter</label>
							<div class="col-sm-6">
										...
										<select name="underwriter_tier[<?php echo $underwriter_tier_key; ?>]"  class="selectpicker" data-actions-box="true">
											...
											<?php foreach($underwriter_tier_obj as $underwriter_tier) {?>
												...
												if ($last_label != $underwriter_tier->underwriter) : ?>
													...
													$selected = '';
													if(($underwriter_tier->id == set_value('underwriter_tier['.$underwriter_tier_key.']',$record->underwriter_tier)))  {
														$selected = 'selected';
													} 
												?> 
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input  step="1" min="0"  type="number" class="form-control" name="premium" id="premium" class="form-control" placeholder="Enter Premium" value="<?php echo set_value('premium',$record->premium) ?>">
