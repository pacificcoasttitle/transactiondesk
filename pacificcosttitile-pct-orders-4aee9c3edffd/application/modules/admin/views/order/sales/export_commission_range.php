...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-sm-6">
                <h1 class="h3 text-gray-800">Export Commission Range</h1>
            </div>
        </div>
        <div class="row">
			<div class="col-md-12">
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Export Commission Range</h6>
					</div>
					<div class="card-body">        
						<form id="frm-import-commission-range" method="POST">
