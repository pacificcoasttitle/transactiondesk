...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-sm-6">
                <h1 class="h3 text-gray-800">Import Commission Range</h1>
            </div>
        </div>
        <div class="row">
			<div class="col-md-12">
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Import Commission Range</h6>
					</div>
					<div class="card-body">        
						<form id="frm-import-commission-range" method="POST"  enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="commission_range_file" class="col-sm-2 col-form-label">Import File <span class="required"> *</span> <a style="font-size: 1rem;" href="<?php echo site_url('order/admin/template-commission-range'); ?>">View Template </a></label>
								<div class="col-sm-6">
									<input type="file" id="commission_range_file" name="file" class="form-control" accept=".csv">
