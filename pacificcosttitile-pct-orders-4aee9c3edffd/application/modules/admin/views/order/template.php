...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/backend/hr/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css">
    ...
    <link
        ...
        rel="stylesheet" />
    <link href="<?php echo base_url(); ?>assets/backend/hr/css/sb-admin-2.min.css?v=02" rel="stylesheet"
        type="text/css">
