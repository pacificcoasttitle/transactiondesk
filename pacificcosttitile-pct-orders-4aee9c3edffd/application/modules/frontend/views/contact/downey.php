	...
	<div class="section-title-page3 area-bg area-bg_blue area-bg_op_60 parallax">
		<div class="area-bg__inner">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<h1 class="b-title-page">Downey Branch</h1>
				...
				<section class="section-default b-contact">
					...
					<div class="b-contact-desc">
						<div class="b-contact-desc__item">
							...
							<div class="b-contact-desc__info">8255 Firestone Blvd. Ste. 100 Downey, CA, 90241</div>
						</div>
						<div class="b-contact-desc__item">
							<div class="b-contact-desc__name">phone</div>
							<div class="b-contact-desc__info">(866) 724-1050</div>
						</div>
						<div class="b-contact-desc__item">
						...
						<div class="b-contact-desc__item">
							...
							<div class="b-contact-desc__info">(818) 662-6780</div>
						</div>
					</div>
					<ul class="social-net list-inline social-net-colors">
						...
						<li class="social-net__item"><a class="social-net__link" href="plus.google.com"><i
									class="icon fa fa-google-plus"></i></a></li>
						<li class="social-net__item"><a class="social-net__link" href="behance.com"><i
									class="icon fa fa-behance"></i></a></li>
						<li class="social-net__item"><a class="social-net__link" href="pinterest.com"><i
...
"></script>
    <!-- Maps customization-->
<script src="<?php echo base_url(); ?>assets/js/map-customd.js"></script>