	...
	<div class="section-title-page3 area-bg area-bg_blue area-bg_op_60 parallax">
		<div class="area-bg__inner">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<h1 class="b-title-page">Glendale Branch</h1>
				...
				<section class="section-default b-contact">
					...
					<div class="b-contact-desc">
						<div class="b-contact-desc__item">
							...
							<div class="b-contact-desc__info">200 W. Glenoaks Blvd. Ste 100 Glendale, CA 91202</div>
						</div>
						<div class="b-contact-desc__item">
...
"></script>
    <!-- Maps customization-->
<script src="<?php echo base_url(); ?>assets/js/map-customdgl.js"></script>