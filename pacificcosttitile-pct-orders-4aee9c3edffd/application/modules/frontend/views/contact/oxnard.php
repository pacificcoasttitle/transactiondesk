	...
	<div class="section-title-page3 area-bg area-bg_blue area-bg_op_60 parallax">
		<div class="area-bg__inner">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<h1 class="b-title-page">Oxnard Branch</h1>
				...
				<section class="section-default b-contact">
					...
					<div class="b-contact-desc">
						<div class="b-contact-desc__item">
							...
							<div class="b-contact-desc__info">1000 Town Center Dr. Ste. 300 Oxnard, CA, 93036</div>
						</div>
						<div class="b-contact-desc__item">
							<div class="b-contact-desc__name">phone</div>
							<div class="b-contact-desc__info">(805) 351-3704 / (866) 724-1050</div>
						</div>
						<div class="b-contact-desc__item">
						...
						<div class="b-contact-desc__item">
							...
							<div class="b-contact-desc__info">(805) 512-8124</div>
						</div>
					</div>
...
"></script>
    <!-- Maps customization-->
    <script src="<?php echo base_url(); ?>assets/js/map-customx.js"></script>