...
@media only screen and (max-width:600px) and (min-width:320px) {
  ...
  .m-height15 {font-size:14px!important;line-height:15px!important;height:15px!important;}
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  ...
  <tr>
    <td align="center" class="center-text">
      <img style="width:340px;border:0px;display:inline!important;" src="<?php echo base_url() . 'assets/media/order/email/logo.png'; ?>" width="340" border="0" alt="logo">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
                                                    <div mc:edit="mcrvl959r6t" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Attention Payoff Admin
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:48px;line-height:54px;font-weight:900;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
                                                    <div mc:edit="mczyhxraxal" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Transactee/Beneficiary  <br>Needs Your Approval.</p></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
                                                <div mc:edit="mcrvl959r6tju" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Details Below</p><p style="margin: 0px; padding: 0px;"><br></p></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <table style="border-collapse: collapse; width: 100%;" border="1">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 15%;background-color:#032e42;color:#ffffff;font-weight:bold;font-family:Rubik;padding:5px; font-size:14px;">Client Name</td>
                                                            <td style="width: 35%;background-color:#032e42;color:#ffffff;font-weight:bold;text-align:center;font-family:Rubik;padding:5px; font-size:14px;">Details</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 15%;color:#a1a1a1;font-family:rubik;height:33px;font-size:14px;">Submitted By:</td>
                                                            <td style="width: 35%;color:#a1a1a1;text-align:center;font-family:rubik;padding:3px; font-size:14px;"> <?=$submitted_by?> </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 15%;color:#a1a1a1;font-family:rubik;height:33px;font-size:14px;">Transactee/Beneficiary Name:</td>
                                                            <td style="width: 35%;color:#a1a1a1;text-align:center;font-family:rubik;padding:3px; font-size:14px;"><?=$transctee_name?></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 15%;color:#a1a1a1;font-family:rubik;height:33px;font-size:14px;">File Number:</td>
                                                            <td style="width: 35%;color:#a1a1a1;text-align:center;font-family:rubik;padding:3px; font-size:14px;"><?=$file_number?></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 15%;color:#a1a1a1;font-family:rubik;height:33px;font-size:14px;">Account Number:</td>
                                                            <td style="width: 35%;color:#a1a1a1;text-align:center;font-family:rubik;padding:3px; font-size:14px;"><?=$account_number?></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 15%;color:#a1a1a1;font-family:rubik;height:33px;font-size:14px;">ABA/Routing #:</td>
                                                            <td style="width: 35%;color:#a1a1a1;text-align:center;font-family:rubik;padding:3px; font-size:14px;"><?=$aba?></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 15%;color:#a1a1a1;font-family:rubik;height:33px;font-size:14px;">Bank Name:</td>
                                                            <td style="width: 35%;color:#a1a1a1;text-align:center;font-family:rubik;padding:3px; font-size:14px;"><?=$bank_name?></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 15%;color:#a1a1a1;font-family:rubik;height:33px;font-size:14px;">Notes:</td>
                                                            <td style="width: 35%;color:#a1a1a1;text-align:center;font-family:rubik;padding:3px; font-size:14px;"><?=$notes?></td>
                                                        </tr>
                                                ...
                                                <table style="border-collapse: collapse; width: 50%;" border="0" align="center">
                                                    <tbody>

                                                        <tr>
                                                            <td align="center" bgcolor="#f26a2a" style="border-radius:0px;">
                                                                <!--[if (gte mso 9)|(IE)]>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <a href="<?php echo base_url() . '/order/admin/transactees-list'; ?>" mc:edit="mct3nxlesjf" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding:15px 35px 15px 35px;display:inline-block;"><span>LOG IN TO APPROVE</span></a>
