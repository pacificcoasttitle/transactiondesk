                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="center" class="center-text">
                                                    <img style="width:340px;border:0px;display:inline!important;"
                                                        src="<?php echo base_url().'assets/media/order/email/production_history_logo.png'; ?>"
                                                        width="340" border="0" alt="logo">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" style="font-size:20px;line-height:20px;">&nbsp;</td>
                            ...
                            <tr>
                                <td align="center" class="img-responsive container-padding">
                                    <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;"
                                        width="640"
                                        src="<?php echo base_url().'assets/media/order/email/production_history_header.jpg'; ?>"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="center-text" align="center"
                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">

                                                                    <div mc:edit="mcrvl959r6t"
                                                                        style="margin: 0px; padding: 0px;">
                                                                        <p style="margin: 0px; padding: 0px;">Good
                                                                            Morning <?php echo $sales_name;?></p>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td class="center-text" align="center"
                                                                    ...
                                                                    <div mc:edit="mczyhxraxal"
                                                                        style="margin: 0px; padding: 0px;">
                                                                        <p style="margin: 0px; padding: 0px;">Openings,
                                                                            Closings &amp; Revenue</p>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <table
                                                                        style="border-collapse: collapse; width: 100%; height: 54px;font-family:arial;"
                                                                        border="1">
                                                                        <tbody>
                                                                            <tr
