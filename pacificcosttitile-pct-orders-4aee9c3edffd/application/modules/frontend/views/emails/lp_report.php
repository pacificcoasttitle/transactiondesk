      ...
      <tbody>
         <tr>
            ...
            <td align="center" bgcolor="#f2f2f2">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td align="center" class="center-text">
                                       <img style="width:340px;border:0px;display:inline!important;" src="<?php echo base_url() . 'assets/media/order/email/lp_stats_logo.png'; ?>" width="340" border="0" alt="logo">
                                    </td>
                                 </tr>
                                 <tr>
                                    <td height="20" style="font-size:20px;line-height:20px;">&nbsp;</td>
               ...
               <table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" width="640" style="width:640px;max-width:640px;">
                  <!-- blue-header -->
                  <tbody>
                     <tr>
                                          ...
                                          <tbody>
                                             <tr>
                                                <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
                                                   <div mc:edit="mcrvl959r6t" style="margin: 0px; padding: 0px;">
                                                      <p style="margin: 0px; padding: 0px;">Good Morning <?php echo $sales_name; ?></p>
                                                   </div>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:48px;line-height:54px;font-weight:900;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
                                                   <div mc:edit="mczyhxraxal" style="margin: 0px; padding: 0px;">
                                                      <p style="margin: 0px; padding: 0px;">15 Day Summary of<br>Listing Prelim Reports</p>
                                                   </div>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
                                                   <div mc:edit="mcrvl959r6tju" style="margin: 0px; padding: 0px;">
                                                      <p style="margin: 0px; padding: 0px;">From <?php echo $start_date; ?> To <?php echo $end_date; ?></p>
                                             ...
                                             <tr>
                                                <td>
                                                   ...
                                                   <p>&nbsp;</p>
                                                   <table style="border-collapse: collapse; width: 100%; height: 72px; font-family:arial;" border="1">
                                                      <tbody>
                                                         <tr style="height: 45px;background-color:#f2f2f2;border-color:#c2c2c2;">
                                                            <td style="width: 33.3333%; font-weight:bold; text-align: center; font-size:20px;" colspan="2">Approval Stats</td>
                                                         </tr>
                                                         <tr style="height: 18px;">
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:17px;border-color:#c2c2c2;">Total Approved</td>
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:17px;border-color:#c2c2c2;">Approval Rate</td>
                                                         </tr>
                                                         <tr style="height: 18px;">
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:25px;border-color:#c2c2c2; color:#f26a2a;"><?php echo $totalApprovedCount;?></td>
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:25px;border-color:#c2c2c2; color:#f26a2a;"><?php echo $totalApprovedCountPer;?></td>
                                                         </tr>
                                                      </tbody>
                                                   </table>
                                                   <p>&nbsp;</p>
                                                   <table style="border-collapse: collapse; width: 100%; height: 72px; font-family:arial;" border="1">
                                                      <tbody>
                                                         <tr style="height: 45px;background-color:#f2f2f2;border-color:#c2c2c2;">
                                                            <td style="width: 33.3333%; font-weight:bold; text-align: center; font-size:20px;" colspan="2">Conversion To Real Order</td>
                                                         </tr>
                                                         <tr style="height: 18px;">
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:17px;border-color:#c2c2c2;">Total Converted</td>
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:17px;border-color:#c2c2c2;">Conversion Rate</td>
                                                         </tr>
                                                         <tr style="height: 18px;">
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:25px;border-color:#c2c2c2; color:#f26a2a;"><?php echo $totalReswareCount;?></td>
                                                            <td style="width: 33.3333%; height: 25px; text-align: center; font-weight:bold; font-size:25px;border-color:#c2c2c2; color:#f26a2a;"><?php echo $totalReswareCountPer;?></td>
                                                         </tr>
                                                      </tbody>
                                                   </table>
                                                   <p>&nbsp;</p>
                                                   <!-- <table style="border-collapse: collapse; width: 100%; height: 54px;font-family:arial;" border="1">
                                                         <tbody>
                                                            <tr style="height: 18px;">
                                                               <td style="width: 48.5%; height: 18px; text-align: center;border-color:#c2c2c2;;background-color:#f2f2f2;">Top Resale Opener</td>
                                                               <td style="width: 1%; height: 18px;background:#d35411;">&nbsp;</td>
                                                               <td style="width: 48.5%; height: 18px;text-align:center;border-color:#c2c2c2;;background-color:#f2f2f2;">Top Refinance Opener</td>
                                                            </tr>
                                                            <tr style="height: 18px;">
                                                               <td style="width: 48.5%; height: 18px; text-align: center;border-color:#c2c2c2;"><?php echo $max_resales_open_orders_sales_name; ?></td>
                                                               <td style="width: 1%; height: 18px; text-align: center;background:#d35411;">&nbsp;</td>
                                                               <td style="width: 48.5%; height: 18px; text-align: center;border-color:#c2c2c2;"><?php echo $max_resales_close_orders_sales_name; ?></td>
                                                            </tr>
                                                            <tr style="height: 18px;">
                                                               <td style="width: 48.5%; height: 18px; text-align: center;border-color:#c2c2c2;"><?php echo $max_resales_open_orders; ?></td>
                                                               <td style="width: 1%; height: 18px; text-align: center;border-color:#c2c2c2;background:#d35411;">&nbsp;</td>
                                                               <td style="width: 48.5%; height: 18px; text-align: center;border-color:#c2c2c2;"><?php echo $max_resales_close_orders; ?></td>
                                                            </tr>
                                                         </tbody>
                                                      </table> -->
                                                   <p>&nbsp;</p>
                                                ...
                                                <td>
                                                   <table style="border-collapse: collapse; width: 100%;" border="1">
                                                      <tbody>
                                                         ...
                                                         <!-- <tr>
                                                               <td style="width: 31.333%;color:#a1a1a1;">John Smith</td>
                                                               <td style="width: 13%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">15</td>
                                                               <td style="width: 13%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">10</td>
                                                               <td style="width: 13%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">22</td>
                                                               <td style="width: 13%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">12</td>
                                                               <td style="width: 16.6667%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">$65,555</td>
                                                            </tr>
                                                            <tr>
                                                               <td style="width: 31.333%;color:#a1a1a1;">John Smith</td>
                                                               <td style="width: 13%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">15</td>
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0" align="center">
                                             <tr>
                                                ...
                                                <td align="center" height="50" style="height:50px;">
                                                   <![endif]-->
                                       <!--   <a href="#" mc:edit="mct3nxlesjf" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding:15px 35px 15px 35px;display:inline-block;"><span>LOG IN TO DASHBOARD</span></a>  -->
                                       <!--[if (gte mso 9)|(IE)]>
                                                </td>
                                                <td align="center" width="35"></td>
                                             </tr>
