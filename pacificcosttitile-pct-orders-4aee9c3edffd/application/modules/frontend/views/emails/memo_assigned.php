...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  ...
  <tr>
    <td align="center" class="center-text">
      <img style="width:340px;border:0px;display:inline!important;" src="<?php echo base_url('assets/frontend/images/pct-logo-email.png');?>" width="340" border="0" alt="logo">
    </td>
  </tr>
  <tr>
    <td height="20" style="font-size:20px;line-height:20px;">&nbsp;</td>
...
<table data-inner-table="" border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row" width="580" style="width:580px;max-width:580px;">
  ...
  <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
      <tbody><tr>
        <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:48px;font-weight:700;font-style:normal;color:#50C0FF;text-decoration:none;letter-spacing:0px;">
            
              <div mc:edit="mcifgvuyvf3" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">
                From Your Human Resources Team</p></div>
            
        </td>
      </tr>
      <tr>
        <td align="center">
          <img style="width:50px;border:0px;display:inline!important;" src="<?php echo base_url('assets/frontend/images/arrow.png') ?>" width="50" border="0" alt="arrow">
        </td>
      </tr>
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center" class="row container-padding" width="90%" style="width:90%;max-width:90%;">
          ...
          <tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
              <tbody><tr>
                <td align="center">
                  <img class="auto-width" style="display:block;width:100%;max-width:140px;border:6px solid #FFFFFF;border-radius:100%;" width="86.3906" src="<?php echo base_url('assets/frontend/images/email-logo-circle.png') ?>" border="0" alt="picture">
                </td>
              </tr>
            </tbody></table>
            <!-- column -->
            ...
            <td class="rwd-col" align="center" valign="top" width="79.53" style="width:79.53%;max-width:79.53%;">
              ...
              <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="100%" style="width:100%;max-width:100%;">
                <tbody><tr>
                  <td class="center-text" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:400;font-style:italic;color:#333333;text-decoration:none;letter-spacing:0px;">
                      
                        <div mc:edit="mcm24yhqr7x" style="margin: 0px; padding: 0px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            ...
            <![endif]-->
                ...
                <a href="<?php echo $botton_url ?>" mc:edit="mca3boy8iae" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding:15px 35px 15px 35px;display:inline-block;"><span>ACKNOWLEDGE IT</span></a>
                ...
                <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height:36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tbody><tr>
                      <td width="10"></td>
                      <td align="center">
                        <img style="width:36px;border:0px;display:inline!important;" src="https://modulescomposer.s3.us-east-2.amazonaws.com/blue/Facebook.png" width="36" border="0" alt="icon">
                      </td>
                      <td width="10"></td>
                    </tr>
                  </tbody></table>
                ...
                <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height:36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tbody><tr>
                      <td width="10"></td>
                      <td align="center">
                        <img style="width:36px;border:0px;display:inline!important;" src="https://modulescomposer.s3.us-east-2.amazonaws.com/blue/Twitter.png" width="36" border="0" alt="icon">
                      </td>
                      <td width="10"></td>
                    </tr>
                  </tbody></table>
                ...
                <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height:36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tbody><tr>
                      <td width="10"></td>
                      <td align="center">
                        <img style="width:36px;border:0px;display:inline!important;" src="https://modulescomposer.s3.us-east-2.amazonaws.com/blue/Pinterest.png" width="36" border="0" alt="icon">
                      </td>
                      <td width="10"></td>
                    </tr>
                  </tbody></table>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
        <tbody><tr>
          <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
              ...
              <div mc:edit="mcz0tuwupjg" style="margin: 0px; padding: 0px;">
                <?php echo date('Y')?> Pacific Coast Title Company. All Rights Reserved.<br>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
        <tbody><tr class="center-on-mobile">
          <td class="rwd-on-mobile center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <a href="*|UNSUB|*" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#666666;text-decoration:none;">Unsubscribe</a>
          </td>
          
          <td class="rwd-on-mobile center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <a href="*|ARCHIVE|*" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#666666;text-decoration:none;">View on browser</a>
          </td>
          
          <td class="rwd-on-mobile center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <a href="*|FORWARD|*" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#666666;text-decoration:none;">Forward</a>
          </td>
        </tr>
      </tbody></table>
    </td>
