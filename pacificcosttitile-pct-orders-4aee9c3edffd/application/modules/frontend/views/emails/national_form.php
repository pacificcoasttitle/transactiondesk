              ...
              <table class="container" width="610" align="center" cellpadding="0" cellspacing="0" border="0" style="width:610px;">
                ...
                <tr>
                  <td class="h2" style="font-family:'Open Sans', Arial, sans-serif;line-height:1.074;font-size:28px;font-weight:700;color:#111111;text-align:center;">
                    NATIONAL TITLE ORDER SUMMARY
                    <br>
                    <span style="color: #000000; font-size: 22px;">Buyer/borrower name: <?php echo $buyer_name; ?></span><br>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="text" style="color:#505050;font-family:'Open Sans', Arial, sans-serif;font-size:14px;line-height:24px;text-align:center;">
                    <p class="xomb-md" style="margin-bottom:.25in;line-height:18pt;" align="center">
                      <span style="font-size: 12.0pt; font-family: Helvetica; color: #424651;"><span style="font-size: 18px;">Thank you for the order.</span>
                    </p>
                    ...
                    <table style="height:32px;border-color:#cccccc;margin-left:auto;margin-right:auto;" border="1" width="581" cellpadding="5">
                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>Buyer/borrower name(s):</strong>
                            </td>
                        ...
                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>Buyer/borrower current address:</strong>
                            </td>
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $buyer_current_address; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $buyer_property_address; ?>
                            </td>
                        </tr>

                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>How will buyer/borrower(s) hold Title?:</strong>
                            </td>
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $title_hold_reason; ?>
                            </td>
                        </tr>

                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>Last 4 digits of buyer/borrower(s) SSN:</strong>
                            </td>
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $ssn; ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $estimated_closing_date; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>Title items required by Lender:</strong>
                            </td>
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $title_items_required_by; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>Lender/Mortgagee clause:</strong>
                            </td>
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $lender_clause; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>Return documents to:</strong>
                            </td>
                            <td style="width:283.576px;text-align:left;">
                                <?php echo $return_document_to; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="width:282.465px;text-align:left;">
                                <strong>Main Lender contact:</strong>
                            </td>
                            <td style="width:283.576px;text-align:left;">
                               <?php echo $main_lender_contact; ?>
                            </td>
                        </tr>
                ...
                <table class="m-w100" align="left" width="285" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;width:285px;">
                  <tr>
                    <td class="text" style="color:#ffffff;font-family:'Open Sans', Arial, sans-serif;font-size:14px;line-height:24px;">
                      ©2024 Pacific Coast Title Company
                    </td>
                  </tr>
                </table>
                <!-- Unsubscribe -->
