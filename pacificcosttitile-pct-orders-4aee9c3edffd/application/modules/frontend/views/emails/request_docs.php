			...
			<tr>
				...
				<td align="center" bgcolor="#F5F5F5">
					<table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0"
						class="outer-table row" role="presentation" width="800" style="width:800px;max-width:800px;">
						<!-- furnistore-logo -->
						<tbody>
							<tr>
							...
							<tr>
								<td class="center-text" align="center">
									<a href="#"
										style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:12px;line-height:12px;font-weight:400;color:#666666;text-decoration:normal;letter-spacing:0px;"></a>
								</td>
							</tr>
							<tr>
								<td align="center" bgcolor="#F5F5F5">
											...
											<tr>
												<td align="center">
													...
													<table border="0" cellpadding="0" cellspacing="0" align="center"
														class="center-float" style="">
														<tbody>
															<tr class="center-on-mobile">
																<td class="rwd-on-mobile" align="center" style="">
																	<!-- Button -->
																		...
																		<tbody>
																			<tr>
																				...
																				<td align="center">
																					...
																					<a href="#"
																						style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;"><span></span></a>
					...
					<table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0"
						class="outer-table row container-padding" role="presentation" width="800"
								...
								<td align="center" bgcolor="#FFFFFF">
									...
									<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
										...
										<tbody>
												...
												<td class="center-text" align="left"
													...
													<div style="margin: 0px; padding: 0px;">
														...
														<p style="margin: 0px; padding: 0px; font-size:18px;">
															<strong><u>
																	<font color="#000000">Escrow Details:</font>
																</u></strong></p>
														<p style="margin: 0px; padding: 0px;"><strong>DATE:</strong>
                                                            <?php echo date('F d, Y'); ?>
														</p>
														<p style="margin: 0px; padding: 0px;"><strong>ESCROW #:</strong>
                                                            <?php echo $file_number; ?>
														</p>
														<p style="margin: 0px; padding: 0px;"><strong>PROPERTY
																ADDRESS:</strong> </p>
														<p style="margin: 0px; padding: 0px;"><?php echo $property_address; ?>
														</p>
														<p style="margin: 0px; padding: 0px;"><u>
																<font color="#d35411"><br></font>
															</u></p>
														...
														<p style="margin: 0px; padding: 0px;font-size:18px;"><u><strong>
																	<font color="#000000">Please click below button for upload documents.
																	</font>
																</strong></u></p>
														...
														<table border="0" cellspacing="0" cellpadding="0"
															...
															<tbody>
																<tr>
																	<td align="center" bgcolor="#d35411" style="border-radius:0px;">
																		<a target="_blank" href="<?php echo $form_url;?>" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:16px;line-height:16px;font-weight:700;font-style:normal;color:rgb(255, 255, 255);text-decoration:none;letter-spacing:0px;padding:15px 20px;display:inline-block;"><span>Go
																				To Page For Upload Documents</span></a>
														...
														<p style="margin: 0px; padding: 0px;"><br></p>
														<p style="margin: 0px; padding: 0px;">The enclosed duplicate
															copies (if any) are for your records.
														</p>
														<p style="margin: 0px; padding: 0px;"></p>
														<p style="margin: 0px; padding: 0px;"><br></p>
														<p style="margin: 0px; padding: 0px;">If you have any questions
															or concerns regarding the enclosed documents or the escrow
															process, please do not hesitate to contact the undersigned.
														</p>
														<p style="margin: 0px; padding: 0px;"><br></p>
														<p style="margin: 0px; padding: 0px;">Sincerely,
														</p>
											...
											<tr>
												<td height="10" style="font-size:25px;line-height:10px;">&nbsp;</td>
											</tr>
											<tr style="">
												<td align="center">
													<!-- Buttons-Container -->
					...
					<table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0"
						class="outer-table row" width="800" style="width:800px;max-width:800px;">
						<!-- furnistore-header -->
						<tbody>
							<tr>
					...
					<table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0"
						...
						<tbody>
							<tr>
								<td align="center" bgcolor="#032535">
									<!-- Content -->
									<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
										width="100%" style="width:100%;max-width:100%;">
										<tbody>
											<tr>
												<td height="47" style="font-size:40px;line-height:47px;">&nbsp;</td>
											</tr>
											<tr>
												<td align="center" class="container-padding">
													...
													<table border="0" cellpadding="0" cellspacing="0" align="center"
														...
														<tbody>
															<tr>
																<td class="rwd-col" valign="top" align="center"
																	width="25%" style="width:25%;max-width:25%;">
																	<!-- column -->
																...
																<td class="rwd-col" valign="top" align="center"
																	...
																	<table border="0" align="center" cellpadding="0"
																		cellspacing="0" role="presentation"
																		class="m-padding-top40" width="100%"
																		style="width:100%;max-width:100%;">
																		<tbody>
																			<tr style="">
																				<td class="center-text" align="left"
																					style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:12px;line-height:24px;font-weight:700;font-style:normal;color:rgb(255, 255, 255);text-decoration:none;letter-spacing:0px;">
																			...
																			<tr style="">
																				<td height="11"
																					style="font-size:15px;line-height:11px;">
																					&nbsp;</td>
																			</tr>
																			<tr style="">
																				<td class="center-text" align="left"
																					style="font-family:Roboto, Arial, Helvetica, sans-serif;font-size:12px;line-height:34px;font-weight:400;font-style:normal;color:rgb(255, 255, 255);text-decoration:none;letter-spacing:0px;">
																...
																<td class="rwd-col" valign="top" align="center"
																	...
																	<table border="0" align="center" cellpadding="0"
																		...
																		<tbody>
																			...
																			<tr style="">
																				<td height="11"
																					style="font-size:20px;line-height:11px;">
																					&nbsp;</td>
																			</tr>
																			<tr>
																				<td align="center" valign="top">
																					<table border="0" align="left"
																						...
																						<tbody>
																							...
																							<tr>
																								<td height="14"
																									style="font-size:18px;line-height:14px;">
																									&nbsp;</td>
																							</tr>
																							...
																							<tr>
																								<td align="left"
																									...
																									<a href="#"
																										style="font-family:Roboto, Arial, Helvetica, sans-serif;font-size:12px;line-height:12px;font-weight:400;font-style:normal;color:rgb(255, 255, 255);text-decoration:none;letter-spacing:0px;display:inline-block;"><img
																											style="width:16px;border:0px;display:inline-block!important;vertical-align:middle;"
																											src="<?php echo base_url().'assets/media/order/email/instrgram.png'; ?>"
																											width="16"
																											border="0"
																											alt="icon"><img
																											data-icon-space=""
