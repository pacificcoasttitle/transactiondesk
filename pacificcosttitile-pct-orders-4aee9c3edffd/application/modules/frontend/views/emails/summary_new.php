                    ...
                    <tbody>
                      ...
                      <tr>
                        <td align="center" class="center-text">
                          <img style="width:340px;border:0px;display:inline!important;" src="<?php echo base_url() . 'assets/media/order/email/summary_logo.png'; ?>" width="340" border="0" alt="logo">
                        </td>
                      </tr>
                      <tr>
                        <td height="20" style="font-size:20px;line-height:20px;">&nbsp;</td>
                              ...
                              <tr>
                                <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
                                  ...
                                  <div mc:edit="mcrvl959r6t" style="margin: 0px; padding: 0px;">
                                    <p style="margin: 0px; padding: 0px;">Good Morning <?php echo $sales_name; ?> below is your</p>
                                  </div>
                              ...
                              <tr>
                                <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:48px;line-height:54px;font-weight:900;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
                                  ...
                                  <div mc:edit="mczyhxraxal" style="margin: 0px; padding: 0px;">
                                    <p style="margin: 0px; padding: 0px;"><?php echo $currentMonth; ?><br> Client Closing Summary</p>
                                  </div>
                              ...
                              <tr>
                                <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
                                  ...
                                  <div mc:edit="mcrvl959r6tju" style="margin: 0px; padding: 0px;">
                                    <p style="margin: 0px; padding: 0px;">As Of: <?php echo date('m/d/Y'); ?></p>
                                ...
                                <td>
                                  ...
                                  <table style="border-collapse: collapse; width: 100%; height: 54px;font-family:arial;" border="1">
                                    <tbody>
                                      <tr style="height: 45px;background-color:#f2f2f2;border-color:#c2c2c2;">
                                        <td style="width: 100%; font-weight:bold; text-align: center; font-size:20px;">
                                          Last Month's Top Client</td>
                                      </tr>
                                      <tr style="height: 18px;">
                                        <td style="width: 40%; height: 25px; text-align: center; font-weight:; font-size:20px;border-color:#c2c2c2; color:#f26a2a;">
                                          <?php echo $lenderName; ?></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  <p>&nbsp;</p>
                                  <table style="border-collapse: collapse; width: 100%; height: 54px;font-family:arial;" border="1">
                                    <tbody>
                                      <tr style="height: 45px;background-color:#f2f2f2;border-color:#c2c2c2;">
                                        <td style="width: 100%; font-weight:bold; text-align: center; font-size:20px;">
                                          Last Month's Top Escrow</td>
                                      </tr>
                                      <tr style="height: 18px;">
                                        <td style="width: 40%; height: 25px; text-align: center; font-weight:; font-size:20px;border-color:#c2c2c2; color:#f26a2a;">
                                          <?php echo $escrowName; ?></td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <tr>
                                <td>
                                  <table style="border-collapse: collapse; width: 100%;" border="1">
                                    <tbody>
										<tr>
											<td style="width: 33%;background-color:#032e42;color:#ffffff;font-weight:bold;text-align:center;font-family:arial;padding:5px; font-size:14px;">
											Client Name</td>
											<td style="width: 33%;background-color:#032e42;color:#ffffff;font-weight:bold;text-align:center;font-family:arial;padding:5px; font-size:14px;">
											Client Company</td>
											<td style="width: 33%;background-color:#032e42;color:#ffffff;font-weight:bold;text-align:center;font-family:arial;padding:5px; font-size:14px;">
										...
										<?php if (!empty($summary_info)) { 
												foreach ($summary_info as $summary) { ?>
													<tr>
														<td style="width: 32%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">
														<?php echo $summary['name']; ?></td>
														<td style="width: 33%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">
														<?php echo $summary['company_name']; ?></td>
														<td style="width: 33%;color:#a1a1a1;text-align:center;font-family:arial;padding:3px; font-size:15px;">
														<?php echo $summary['count']; ?></td>
													</tr>
										<?php } } else { ?>
											<tr>
												No Records Found.
