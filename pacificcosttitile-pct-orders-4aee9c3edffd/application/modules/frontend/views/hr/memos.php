            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="typography-section__inner">
                        <h2 class="ui-title-block ui-title-block_light">Memos History,</h2>
                        <div class="ui-decor-1a bg-accent"></div>
                        <h3 class="ui-title-block_light">Below is a detail of all your memos.</h3>
                    </div>
                    ...
                    <div class="typography-sectiona">
                        <div class="table-container">
                            <table class="table table-type-3 typography-last-elem" id="memos_listing" width="100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Subject</th>
