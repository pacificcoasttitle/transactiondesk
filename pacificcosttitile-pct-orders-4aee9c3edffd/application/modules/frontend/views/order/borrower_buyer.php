                                ...
                                <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-80 mt-5">
                                            Dated:    
                                            <input type="text" class="w30 input_single" id="buyer_date" name="buyer_date" value="<?php echo $buyerInfo['buyer_date'] ? $buyerInfo['buyer_date'] : '';?>" required data-error="#buyer_date-error">
                                            <label id="buyer_date-error" class="error text-danger d-flex" for="buyer_date"></label>
                                        </div>
                                       

                                        <input type="text" class="signature" placeholder="signature" id="buyer_signature" name="buyer_signature" value="<?php echo $buyerInfo['buyer_signature'] ? $buyerInfo['buyer_signature'] : '';?>" required data-error="#buyer_signature-error">  
