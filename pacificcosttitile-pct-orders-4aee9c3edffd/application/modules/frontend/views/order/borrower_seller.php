                                ...
                                <div id="collapseEighteen" class="accordion-collapse collapse" aria-labelledby="headingEighteen" data-bs-parent="#accordionExample" style="">
                                    <div class="accordion-body">
                                        ...
                                        <div class="form-group position-relative mb-3 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="seller_name" name="seller_name" value="<?php echo $sellerInfo['seller_name'] ? $sellerInfo['seller_name'] : '';?>" required="required" data-error="#seller_name-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="escrow_home_phone_number" name="escrow_home_phone_number" value="<?php echo $sellerInfo['escrow_home_phone_number'] ? $sellerInfo['escrow_home_phone_number'] : '';?>" required="required" data-error="#escrow_home_phone_number-error">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="work_phone_number" name="work_phone_number" value="<?php echo $sellerInfo['work_phone_number'] ? $sellerInfo['work_phone_number'] : '';;?>" required="required" data-error="#work_phone_number-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="fax_number" name="fax_number" value="<?php echo $sellerInfo['fax_number'] ? $sellerInfo['fax_number'] : '';;?>" required="required" data-error="#fax_number-error">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="cell_phone_number" name="cell_phone_number" value="<?php echo $sellerInfo['cell_phone_number'] ? $sellerInfo['cell_phone_number'] : '';?>" required="required" data-error="#cell_phone_number-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="email_address" name="email_address" value="<?php echo $sellerInfo['email_address'] ? $sellerInfo['email_address'] : '';?>" required="required" data-error="#email_address-error">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="cell_phone_number_2" name="cell_phone_number_2" value="<?php echo $sellerInfo['cell_phone_number_2'] ? $sellerInfo['cell_phone_number_2'] : '';?>" required="required" data-error="#cell_phone_number_2-error">
                                                    <small class="small_label">Cell Phone Number:</small>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="escrow_ssn" name="escrow_ssn" value="<?php echo $sellerInfo['escrow_ssn'] ? $sellerInfo['escrow_ssn'] : '';?>" required="required" data-error="#escrow_ssn-error">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="ssn_2" name="ssn_2" value="<?php echo $sellerInfo['ssn_2'] ? $sellerInfo['ssn_2'] : '';?>" required="required" data-error="#ssn_2-error">
                                                    <small class="small_label">Social Security #:</small>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <textarea rows="2" class="form-control" style="height:auto;" id="property_address" name="property_address" required="required" data-error="#property_address-error"><?php echo $sellerInfo['property_address'] ? $sellerInfo['property_address'] : '';?></textarea>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <textarea rows="2" class="form-control" style="height:auto;" id="seller_current_mailing_address" name="seller_current_mailing_address"  required="required" data-error="#seller_current_mailing_address-error"><?php echo $sellerInfo['seller_current_mailing_address'] ? $sellerInfo['seller_current_mailing_address'] : '';?></textarea>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <textarea rows="2" class="form-control" style="height:auto;" id="seller_mailing_address_after_close_escrow" name="seller_mailing_address_after_close_escrow"  required="required" data-error="#seller_mailing_address_after_close_escrow-error"><?php echo $sellerInfo['seller_mailing_address_after_close_escrow'] ? $sellerInfo['seller_mailing_address_after_close_escrow'] : '';?></textarea>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <textarea rows="2" class="form-control" style="height:auto;" id="seller_mailing_address_after_close_escrow_2" name="seller_mailing_address_after_close_escrow_2"  required="required" data-error="#seller_mailing_address_after_close_escrow_2-error"><?php echo $sellerInfo['seller_mailing_address_after_close_escrow_2'] ? $sellerInfo['seller_mailing_address_after_close_escrow_2'] : '';?></textarea>
                                                <small class="small_label">Seller(s) Mailing Address after Close of Escrow: </small>
                                        ...
                                        <div class="form-group position-relative mb-3 mt-3">
                                            <label for="" class="mb-2"><b></b></label>
                                            <input type="text" class="form-control" id="first_trust_deed_lender" name="first_trust_deed_lender" value="<?php echo $sellerInfo['first_trust_deed_lender'] ? $sellerInfo['first_trust_deed_lender'] : '';?>" required="required" data-error="#first_trust_deed_lender-error">
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <textarea rows="2" class="form-control" style="height:auto;" id="lender_address" name="lender_address" required="required" data-error="#lender_address-error"><?php echo $sellerInfo['lender_address'] ? $sellerInfo['lender_address'] : '';?>"</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="loan_number" name="loan_number" value="<?php echo $sellerInfo['loan_number'] ? $sellerInfo['loan_number'] : '';?>" required="required" data-error="#loan_number-error">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="lender_phone_number" name="lender_phone_number" value="<?php echo $sellerInfo['lender_phone_number'] ? $sellerInfo['lender_phone_number'] : '';?>" required="required" data-error="#lender_phone_number-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="unpaid_principal_balance" name="unpaid_principal_balance" value="<?php echo $sellerInfo['unpaid_principal_balance'] ? $sellerInfo['unpaid_principal_balance'] : '';?>" required="required" data-error="#unpaid_principal_balance-error">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="next_due" name="next_due" value="<?php echo $sellerInfo['next_due'] ? $sellerInfo['next_due'] : '';?>" required="required" data-error="#next_due-error">
                                        ...
                                        <div class="row">
                                            <div class="row mt-4">
                                                <div class="col-lg-9 col-md-8">
                                                    <div class="mb-3">
                                                        Type of Loan: <input type="text" class="input_single w-medium" id="type_of_loan" name="type_of_loan" value="<?php echo $sellerInfo['type_of_loan'] ? $sellerInfo['type_of_loan'] : '';?>"> VA <input type="text" class="input_single w-medium" id="va" name="va" value="<?php echo $sellerInfo['va'] ? $sellerInfo['va'] : '';?>">FHA <input type="text" class="input_single w-medium" id="fha" name="fha" value="<?php echo $sellerInfo['fha'] ? $sellerInfo['fha'] : '';?>">Conventional <input type="text" class="input_single w-medium" id="conventional" name="conventional" value="<?php echo $sellerInfo['conventional'] ? $sellerInfo['conventional'] : '';?>">Equity Line/Line of Credit
                                                    </div>
                                                    <div>
                                                        TAXES: <input type="text" class="input_single w-medium" id="taxes" name="taxes" value="<?php echo $sellerInfo['taxes'] ? $sellerInfo['taxes'] : '';?>">Paid <input type="text" class="input_single w-medium" id="paid" name="paid" value="<?php echo $sellerInfo['paid'] ? $sellerInfo['paid'] : '';?>"> Unpaid<input type="text" class="input_single w-medium" id="unpaid" name="unpaid" value="<?php echo $sellerInfo['unpaid'] ? $sellerInfo['unpaid'] : '';?>"> Taxes are being paid through my impound account
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="d-flex">
                                                        Impound Acct:
                                                        <div class="ms-2">
                                                            <input type="radio" id="impondYes" value="yes" name="is_impound_acc" value="<?php echo $sellerInfo['is_impound_acc'] ? $sellerInfo['is_impound_acc'] : '';?>">
                                                            <label for="impondYes">Yes</label>
                                                        </div>
                                                        <div class="ms-2">
                                                            <input type="radio" id="impondNo" value="no" name="is_impound_acc" value="<?php echo $sellerInfo['is_impound_acc'] ? $sellerInfo['is_impound_acc'] : '';?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <input type="text" class="form-control" id="second_trust_deed_lender" name="second_trust_deed_lender" value="<?php echo $sellerInfo['second_trust_deed_lender'] ? $sellerInfo['second_trust_deed_lender'] : '';?>" required="required" data-error="#second_trust_deed_lender-error">
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <textarea rows="2" class="form-control" style="height:auto;" id="second_lender_address" name="second_lender_address"  required="required" data-error="#second_lender_address-error"><?php echo $sellerInfo['second_lender_address'] ? $sellerInfo['second_lender_address'] : '';?></textarea>
                                                <small class="small_label">Address:</small>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="second_loan_number" name="second_loan_number" value="<?php echo $sellerInfo['second_loan_number'] ? $sellerInfo['second_loan_number'] : '';?>" required="required" data-error="#second_loan_number-error">
                                                    <small class="small_label">Loan Number:</small>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="second_lender_phone_number" name="second_lender_phone_number" value="<?php echo $sellerInfo['second_lender_phone_number'] ? $sellerInfo['second_lender_phone_number'] : '';?>" required="required" data-error="#second_lender_phone_number-error">
                                                    <small class="small_label">Phone Number:</small>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3 col-md-6">
                                                <label for="" class="mb-2"><b></b></label>
                                                <input type="text" class="form-control" id="second_unpaid_principal_balance" name="second_unpaid_principal_balance" value="<?php echo $sellerInfo['second_unpaid_principal_balance'] ? $sellerInfo['second_unpaid_principal_balance'] : '';?>" required="required" data-error="#second_unpaid_principal_balance-error">
                                                <small class="small_label">Unpaid Principal Balance $:</small>
                                            </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    Type of Loan: <input type="text" class="input_single w-medium" id="second_type_of_loan" name="second_type_of_loan" value="<?php echo $sellerInfo['second_type_of_loan'] ? $sellerInfo['second_type_of_loan'] : '';?>"> VA <input type="text" class="input_single w-medium" id="second_va" name="second_va" value="<?php echo $sellerInfo['second_va'] ? $sellerInfo['second_va'] : '';?>">FHA <input type="text" class="input_single w-medium" id="second_fha" name="second_fha" value="<?php echo $sellerInfo['second_fha'] ? $sellerInfo['second_fha'] : '';?>">Conventional <input type="text" class="input_single w-medium" id="second_conventional" name="second_conventional" value="<?php echo $sellerInfo['second_conventional'] ? $sellerInfo['second_conventional'] : '';?>">Equity Line/Line of Credit
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <input type="text" class="form-control" id="homeowner_association" name="homeowner_association" value="<?php echo $sellerInfo['homeowner_association'] ? $sellerInfo['homeowner_association'] : '';?>" required="required" data-error="#homeowner_association-error">
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <input type="text" class="form-control" id="management_company" name="management_company" value="<?php echo $sellerInfo['management_company'] ? $sellerInfo['management_company'] : '';?>" required="required" data-error="#management_company-error">
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                ...
                                                <input type="text" class="form-control" id="management_mailing_address" name="management_mailing_address" value="<?php echo $sellerInfo['management_mailing_address'] ? $sellerInfo['management_mailing_address'] : '';?>" required="required" data-error="#management_mailing_address-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="contact_person" name="contact_person" required="required" value="<?php echo $sellerInfo['contact_person'] ? $sellerInfo['contact_person'] : '';?>" data-error="#contact_person-error">
                                            ...
                                            <div class="col-md-6">         
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="management_phone_number" name="management_phone_number" value="<?php echo $sellerInfo['management_phone_number'] ? $sellerInfo['management_phone_number'] : '';?>" required="required" data-error="#management_phone_number-error">
                                                    <small class="small_label">Phone Number:</small>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <input type="text" class="form-control" id="second_homeowner_association" name="second_homeowner_association" value="<?php echo $sellerInfo['second_homeowner_association'] ? $sellerInfo['second_homeowner_association'] : '';?>" required="required" data-error="#second_homeowner_association-error">
                                                <small class="small_label">Homeowner’s Association: </small>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <input type="text" class="form-control" id="second_management_company" name="second_management_company" value="<?php echo $sellerInfo['second_management_company'] ? $sellerInfo['second_management_company'] : '';?>" required="required" data-error="#second_management_company-error">
                                                <small class="small_label">Management Company: </small>
                                        ...
                                        <div class="row">
                                            <div class="form-group position-relative mb-3 mt-3">
                                                <label for="" class="mb-2"><b></b></label>
                                                <input type="text" class="form-control" id="second_management_mailing_address" name="second_management_mailing_address" value="<?php echo $sellerInfo['second_management_mailing_address'] ? $sellerInfo['second_management_mailing_address'] : '';?>" required="required" data-error="#second_management_mailing_address-error">
                                                <small class="small_label">Mailing Address: </small>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="second_contact_person" name="second_contact_person" value="<?php echo $sellerInfo['second_contact_person'] ? $sellerInfo['second_contact_person'] : '';?>" required="required" data-error="#second_contact_person-error">
                                                    <small class="small_label">Contact Person:</small>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="second_management_phone_number" name="second_management_phone_number" value="<?php echo $sellerInfo['second_management_phone_number'] ? $sellerInfo['second_management_phone_number'] : '';?>" required="required" data-error="#second_management_phone_number-error">
                                                    <small class="small_label">Phone Number:</small>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="water_company_name" name="water_company_name" value="<?php echo $sellerInfo['water_company_name'] ? $sellerInfo['water_company_name'] : '';?>" required="required" data-error="#water_company_name-error">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="water_contract_name" name="water_contract_name" value="<?php echo $sellerInfo['water_contract_name'] ? $sellerInfo['water_contract_name'] : '';?>" required="required" data-error="#water_contract_name-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="water_company_address" name="water_company_address" value="<?php echo $sellerInfo['water_company_address'] ? $sellerInfo['water_company_address'] : '';?>" required="required" data-error="#water_company_address-error">
                                                    <small class="small_label">Address: </small>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="water_company_phone" name="water_company_phone" value="<?php echo $sellerInfo['water_company_phone'] ? $sellerInfo['water_company_phone'] : '';?>" required="required" data-error="#water_company_phone-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="amount_of_assessment" name="amount_of_assessment" value="<?php echo $sellerInfo['amount_of_assessment'] ? $sellerInfo['amount_of_assessment'] : '';?>" required="required" data-error="#amount_of_assessment-error">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="water_next_due" name="water_next_due" value="<?php echo $sellerInfo['water_next_due'] ? $sellerInfo['water_next_due'] : '';?>" required="required" data-error="#water_next_due-error">
                                                    <small class="small_label">Next Due </small>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="no_of_shares" name="no_of_shares" value="<?php echo $sellerInfo['no_of_shares'] ? $sellerInfo['no_of_shares'] : '';?>" required="required" data-error="#no_of_shares-error">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="mt-5">
                                                    Date :    
                                                    <input type="text" class="input_single" id="date" name="date" value="<?php echo $sellerInfo['date'] ? $sellerInfo['date'] : '';?>" required="required" data-error="#date-error">
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mt-5">
                                                    <input type="text" class="input_single d-block w-full" id="escrow_signature" name="escrow_signature" value="<?php echo $sellerInfo['escrow_signature'] ? $sellerInfo['escrow_signature'] : '';?>" required="required" data-error="#escrow_signature-error">
                                                    Luz Amparo Rockey
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6">
                                                    <div class="form-group position-relative mb-3">
                                                        <label for="" class="mb-2"><b></b></label>
                                                        <input type="text" class="form-control" id="first_name" name="first_name" required="required" data-error="#first_name-error">
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    <div class="form-group position-relative mb-3">
                                                        <label for="" class="mb-2"><b></b></label>
                                                        <input type="text" class="form-control" id="middle_name" name="middle_name" required="required" data-error="#middle_name-error">
                                ...
                                <div id="collapseTwenty" class="accordion-collapse collapse" aria-labelledby="headingTwenty" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-3">
                                                <div>
                                                    ...
                                                    <input type="checkbox" id="is_amended" name="is_amended" value="yes">
                                                </div>
                                            </div>
                                            <div class="col-md-9 text-end">
                                                <div>
                                                    <label for="amended">Escrow or Exchange No.  </label>
                                                    <input type="innput" class="input_single" readonly value="10257432-GLE-MP">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <strong>Part I  Remitter Information</strong> &nbsp;
                                            <input type="checkbox" id="remitter1" name="remitter_info[]" value="REEP"> &nbsp;
                                            <label for="remitter1">REEP</label> &nbsp;
                                            <input type="checkbox" id="remitter2" name="remitter_info[]" value="qualified_intermediary"> &nbsp;
                                            <label for="remitter2">Qualified Intermediary</label> &nbsp;
                                            <input type="checkbox" id="remitter3" name="remitter_info[]" value="transferee"> &nbsp;
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="Pacific Coast Title Company" id="business_name" name="business_name">
                                                    <small class="small_label">Business name</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="checkbox" id="fein" name="business_num[]" value="fein"> &nbsp;
                                                <label for="fein">FEIN</label> &nbsp;
                                                <input type="checkbox" id="corpNo" name="business_num[]" value="corpNo"> &nbsp;
                                                <label for="corpNo">CA Corp no.</label> &nbsp;
                                                <input type="checkbox" id="sosNo" name="business_num[]" value="sosNo"> &nbsp;
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="remitter_first_name" name="remitter_first_name">
                                                    <small class="small_label">First name</small>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="remitter_initial_name" name="remitter_initial_name">
                                                    <small class="small_label">Initial</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="remitter_last_name" name="remitter_last_name">
                                                    <small class="small_label">last name</small>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="remitter_ssn_or_itin" name="remitter_ssn_or_itin">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="516 Burchett St." id="remitter_address" name="remitter_address">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="Glendale" id="remitter_city" name="remitter_city">
                                                    <small class="small_label">City (If you have a foreign address, see instructions.)</small>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="CA" id="remitter_state" name="remitter_state">
                                                    <small class="small_label">State</small>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="91203" id="remitter_zip_code" name="remitter_zip_code"> 
                                                    <small class="small_label">ZIP code</small>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="(818) 662-6700" id="remitter_telephone_num" name="remitter_telephone_num">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="checkbox" id="granter" name="trust_types[]" value="granter"> &nbsp;
                                            <label for="granter">Grantor</label> &nbsp;
                                            <input type="checkbox" id="nongranter" name="trust_types[]" value="nongranter"> &nbsp;
                                            <label for="nongranter">Nongrantor Trust</label>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_first_name" name="transferor_first_name">
                                                    <small class="small_label">First name</small>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_initial_name" name="transferor_initial_name">
                                                    <small class="small_label">Initial</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_last_name" name="transferor_last_name">
                                                    <small class="small_label">last name</small>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_ssn_or_itin" name="transferor_ssn_or_itin">
                                                    <small class="small_label">SSN or ITIN</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                <input type="checkbox" id="fein1" name="transferor_business_num[]" value="fein"> &nbsp;
                                                <label for="fein1">FEIN</label> &nbsp;
                                                <input type="checkbox" id="corpNo1" name="transferor_business_num[]" value="corpNo"> &nbsp;
                                                <label for="corpNo1">CA Corp no.</label> &nbsp;
                                                <input type="checkbox" id="sosNo1" name="transferor_business_num[]" value="sosNo"> &nbsp;
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_address" name="transferor_address">
                                                    <small class="small_label">Address (apt./ste., room, PO box, or PMB no.) </small>
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_city" name="transferor_city">
                                                    <small class="small_label">City (If you have a foreign address, see instructions.)</small>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_state" name="transferor_state">
                                                    <small class="small_label">State </small>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_zip_code" name="transferor_zip_code">
                                                    <small class="small_label">ZIP code</small>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="transferor_telephone_number" name="transferor_telephone_number">
                                                    <small class="small_label">Telephone number</small>
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" id="ownership_percentage" name="ownership_percentage">
                                        ...
                                        <ol>
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkOne" class="mt-1 me-2" value="certification_1" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkTwo" class="mt-1 me-2" value="certification_2" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkThree" class="mt-1 me-2" value="certification_3" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkFour" class="mt-1 me-2" value="certification_4" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkFive" class="mt-1 me-2" value="certification_5" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkSix" class="mt-1 me-2" value="certification_6" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkSeven" class="mt-1 me-2" value="certification_7" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkEight" class="mt-1 me-2" value="certification_8" name="certifications[]">
                                                    <label for="checkEight">The seller is a tax-exempt entity under California or federal law.</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkNine" class="mt-1 me-2" value="certification_9" name="certifications[]">
                                        ...
                                        <ol start="10">
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkTen" class="mt-1 me-2" value="certification_10" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkEleven" class="mt-1 me-2" value="certification_11" name="certifications[]">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-start">
                                                    <input type="checkbox" id="checkTwelve" class="mt-1 me-2" value="certification_12" name="certifications[]">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-8">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="Pacific Coast Title Company" id="remitter_name" name="remitter_name">
                                                    <small class="small_label">Remitter name</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group position-relative mb-3">
                                                    <input type="text" class="form-control" value="95-2569776" id="remitter_ssn_fein" name="remitter_ssn_fein">
                                        ...
                                        <ol start="31">
                                            ...
                                            <li>
                                                <div class="d-flex flex-xs-wrap mb-2">
                                                    <span>Date of Transfer, Exchange Completion, Failed Exchange, or Installment Payment...........(mm/dd/yyyy)</span>&nbsp;<input type="text" class="input_single flex1" id="date_of_transfer" name="date_of_transfer">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex flex-xs-wrap mb-2">
                                            ...
                                            <li>
                                                <div class="d-flex flex-xs-wrap mb-2">
                                                    <span>Amount that should have been withheld</span>&nbsp;<input type="text" class="input_single flex1" id="amount_withheld_from" name="amount_withheld_from">,<input type="text" class="input_single flex1" id="amount_withheld_to" name="amount_withheld_to">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex flex-xs-wrap mb-2">
                                                    <span>
                                                        ...
                                                        <label>
                                                            <b>A</b> <input type="radio" class="square_radio mb-2" name="transaction" value="conventional_sale" id="transaction1">
                                                            <label for="transaction1">Conventional Sale/Transfer</label>&nbsp;
                                                            <b>C</b> <input type="radio" class="square_radio" name="transaction" value="boot"  id="transaction2">
                                                            <label for="transaction2">Boot</label>&nbsp;
                                                            <b>E</b> <input type="radio" class="square_radio" name="transaction" value="cash_poor"  id="transaction3">
                                                            <label for="transaction3">Cash Poor</label><br>
                                                            <b>B</b> <input type="radio" class="square_radio" name="transaction" value="installment_sale_payment"  id="installment_sale_payment">
                                                            <label for="transaction4">Installment Sale Payment</label>&nbsp;
                                                            <b>D</b> <input type="radio" class="square_radio" name="transaction" value="failed_exchange"  id="failed_exchange">
                                            ...
                                            <li>
                                                <div class="d-flex flex-xs-wrap mb-2">
                                                    <span>Amount Withheld from this Seller/Transferor</span>&nbsp;<input type="text" class="input_single flex1" id="amount_withheld" name="amount_withheld">
                                                </div>
                                            </li>
                                        </ol>
                                        <div class="notice_box mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                <input type="checkbox" class="mt-1 me-2" id="sale1" name="perjury[]" value="sale1">
                                                <label for="sale1">The sale is fully exempt from withholding as indicated by a check mark(s) in Part III.</label>
                                            </div>
                                            <div class="d-flex align-items-start mb-2">
                                                <input type="checkbox" class="mt-1 me-2" id="sale2" name="perjury[]" value="sale2">
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                <input type="checkbox" class="mt-1 me-2" id="sale3" name="perjury[]" value="sale3">
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                <input type="checkbox" checked class="mt-1 me-2" id="sale4" name="perjury[]" value="sale4">
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                <input type="checkbox" class="mt-1 me-2" id="sale5" name="perjury[]" value="sale5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row mb-3 mt-md-0 mt-4">
                                                    <div class="col-md-8">
                                                        <input type="text" class="input_single w-full mb-2" id="seller_transferor_signature" name="seller_transferor_signature">
                                                        Seller's/Transferor's signature 
                                                    </div>
                                                    <div class="col-md-4 mt-md-0 mt-2">
                                                        <input type="text" class="input_single w-full mb-2" id="seller_transferor_date" name="seller_transferor_date">
                                                        Date
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-8">
                                                        <input type="text" class="input_single w-full mb-2" id="seller_transferor_spouse_signature" name="seller_transferor_spouse_signature">
                                                        Seller's/Transferor's spouse's/RDP's signature 
                                                    </div>
                                                    <div class="col-md-4 mt-md-0 mt-2">
                                                        <input type="text" class="input_single w-full mb-2" id="seller_transferor_spouse_date" name="seller_transferor_spouse_date">
                                                        Date
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-8">
                                                        <input type="text" class="input_single w-full mb-2" id="buyer_transferor_signature" name="buyer_transferor_signature">
                                                        Buyer's/Transferee's signature 
                                                    </div>
                                                    <div class="col-md-4 mt-md-0 mt-2">
                                                        <input type="text" class="input_single w-full mb-2" id="buyer_transferor_date" name="buyer_transferor_signature">
                                                        Date
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-8">
                                                        <input type="text" class="input_single w-full mb-2" id="buyer_transferor_spouse_signature" name="buyer_transferor_spouse_signature">
                                                        Buyer's/Transferee's spouse's/RDP's signature
                                                    </div>
                                                    <div class="col-md-4 mt-md-0 mt-2">
                                                        <input type="text" class="input_single w-full mb-2" id="buyer_transferor_spouse_date" name="buyer_transferor_spouse_date">
                                                        Date
                                                    </div>
                                                </div>
                                                <div class="row">
                                    ...
                                    <div class="accordion-body">                                        
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                Date of closing: <input type="text" class="w-half input_single" id="date_of_closing" name="date_of_closing">
                                            </div> 
                                        </div>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-7">
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="sellers_name" name="sellers_name">
                                                    <small class="small_label">Sellers Name (First, MI, Last or Entity Name)</small>
                                                </div>
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="personal_representative" name="personal_representative">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group position-relative mb-3 mt-3">
                                                    <label for="" class="mb-2"><b></b></label>
                                                    <input type="text" class="form-control" id="federal_tax" name="federal_tax">
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <input type="checkbox" name="is_exchange" id="is_exchange" value="yes"> <label for="exchange">Exchange (If checked)</label>
                                                    <div class="mt-5">$ <input type="text" class="input_single" id="tax_credit" name="tax_credit"> Tax Credit to Seller (Real property tax credits to seller contained in the 400 series of the HUD-1 or comparable closing statement form.)</div>
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex">
                                                    <input type="checkbox" name="is_outside" id="is_outside" value="yes" class="me-3"> <label for="outside"><small>Check here if the address is outside of the U.S.A.</small></label>
                                                </div>
                                                <div class="d-flex">
                                                    <input type="checkbox" name="is_regulations" id="is_regulations"  value="yes" class="me-3"> <label for="regulations"><small>Check here if you are a foreign person per IRS regulations (nonresident alien, foreign partnership, foreign estate, or foreign trust.) Do not sign below.</small></label>
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-6">
                                            <div>
                                                <input type="text" class="w-full input_single" id="tranferor_signature" name="tranferor_signature">
                                                Transferor’s Signature
                                            </div>
                                            <div>
                                                <input type="text" class="w-full mt-3 input_single" id="spouse_signature" name="spouse_signature">
                                                Spouse
                                            </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div>
                                                    <input type="text" class="w-full input_single" id="tranferor_date" name="tranferor_date">
                                                    Date
                                                </div>
                                                <div>
                                                    <input type="text" class="w-full mt-3 input_single" id="spouse_date" name="spouse_date">
                                                    Date
                                                </div>
                                            </div> 
                                        </div>
							...
							<div class="accordion-item">
                                ...
                                <div id="collapse22" class="accordion-collapse collapse" aria-labelledby="heading22" data-bs-parent="#accordionExample" style="">
                                    <div class="accordion-body">
                                        ...
                                        <ol>
                                            ...
                                            <li>
                                                <div class="d-flex flex-xs-wrap my-2">
                                                    My U.S. taxpayer identifying no. (Social Security No.) is: <input type="text" class="input_single flex1" id="taxpayer_identifying_num" name="taxpayer_identifying_num">;
                                                </div>
                                            </li>
                                            <li>
                                        ...
                                        <div class="mt-5">
                                            Date :    
                                            <input type="text" class="input_single" id="firpta_date" name="firpta_date">
                                        </div>
                                        <div class="mt-5 row">
                                            <div class="col-md-4">
                                                <input type="text" class="input_single d-block w-full" id="firpta_signature" name="firpta_signature">
                                                Luz Amparo Rockey
                                            </div>
                                        </div>
                                    </div>
