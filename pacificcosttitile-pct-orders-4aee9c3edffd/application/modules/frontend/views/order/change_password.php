...
<head>
    ...
    <style>
        ...
        #confirm_password_php_error{
            display: none;
        }

        #confirm_password_php_error p {
            margin: 0px 0 12px 0 !important;
            padding: 0px !important;
            font-family: Arial, Helvetica, sans-serif;
            font-style: normal;
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <div class="page-links">
                            <a href="login2.html" class="active">Change Password</a>
                            <!-- <a href="register2.html">Register</a> -->
                        </div>
                        <form method="POST" action="<?php echo base_url();?>change-password/<?php echo $hash;?>" name="change-password-form" id="change-password-form" enctype="multipart/form-data">
                            <label class="field state-error" style="display:block;">
                                <input class="form-control gui-input" type="password" name="password" id="password" placeholder="New password">
                            </label>
                            ...
                            <label class="field state-error" style="display:block;">
                                <input class="form-control gui-input" type="password" name="confirm_password" id="confirm_password" placeholder="Confirm new password">
                            </label>
                            
                            <span id="confirm_password_php_error" class=""></span>
