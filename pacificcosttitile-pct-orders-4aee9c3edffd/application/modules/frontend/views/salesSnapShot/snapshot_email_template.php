              ...
              <table class="container" width="610" align="center" cellpadding="0" cellspacing="0" border="0" style="width:610px;">
                ...
                <tr>
                  <td class="h2" style="font-family:'Open Sans', Arial, sans-serif;line-height:1.074;font-size:28px;font-weight:700;color:#111111;text-align:center;">
                    Snap Shot!
                    <br>
                    <span style="color: #d35400; font-size: 22px;">Details Below</span>
                ...
                <tr>
                    <td class="text" style="color:#505050;font-family:'Open Sans', Arial, sans-serif;font-size:14px;line-height:24px;text-align:center;">
                        ...
                        <p class="xomb-md" style="margin-bottom:.25in;line-height:18pt;text-align:center;" align="center">
                            <span style="font-size: 12.0pt; font-family: Helvetica; color: #424651;"><span style="font-size: 18px;">Attached you will find copies of the snapshot documents:</span></span>
                        </p>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                                        <a class="mcnButton " title="Download document" href="<?=$link?>" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;" download>Download Document</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
