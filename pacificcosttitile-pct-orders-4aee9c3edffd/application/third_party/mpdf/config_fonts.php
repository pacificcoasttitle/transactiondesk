...
/* Arabic fonts */
	...
	"kfgqpcuthmantahanaskh" => array(	/* KFGQPC Uthman Taha Naskh - Koranic */
        ...
        "noterapersonaluseonly-6i" => array(	
		'R' => "NoteraPersonalUseOnly_6i.ttf",
                'B' => "NoteraPersonalUseOnly_6i.ttf",
                'I' => "NoteraPersonalUseOnly_6i.ttf",
		),
        "bariol-bold-6p" => array(	
		'R' => "Bariol-Bold_6p.ttf",
                'B' => "Bariol-Bold_6p.ttf",
                'I' => "Bariol-Bold_6p.ttf",
		),
        "museosansrounded-900-7g" => array(	
		'R' => "MuseoSansRounded-900_7g.ttf",
                'B' => "MuseoSansRounded-900_7g.ttf",
                'I' => "MuseoSansRounded-900_7g.ttf",
		),
        "museosansrounded-300-7h" => array(	
		'R' => "MuseoSansRounded-300_7h.ttf",
                'B' => "MuseoSansRounded-300_7h.ttf",
                'I' => "MuseoSansRounded-300_7h.ttf",
		),
        "museosansrounded-700-6v" => array(	
		'R' => "MuseoSansRounded-700_6v.ttf",
                'B' => "MuseoSansRounded-700_6v.ttf",
                'I' => "MuseoSansRounded-700_6v.ttf",
		),
    "andikanewbasic" => array(	
		'R' => "AndikaNewBasic-R.ttf",
                'B' => "AndikaNewBasic-B.ttf",
                'I' => "AndikaNewBasic-I.ttf",
                'BI' => "AndikaNewBasic-BI.ttf",
		),
    "allura-regular" => array(	
		'R' => "Allura-Regular.ttf",
                'B' => "Allura-Regular.ttf",
                'I' => "Allura-Regular.ttf",
		),
    ...
    "GlacialIndifference" => array(	
		'R' => "GlacialIndifference-Regular.ttf",
                'B' => "GlacialIndifference-Bold.ttf",
                'I' => "GlacialIndifference-Regular.ttf",
		),
