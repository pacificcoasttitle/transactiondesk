...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="http://www.pct.com/image/x-icon" href="favicon.ico">
    ...
    <div class="l-theme animated-css" data-header="sticky" data-header-top="200" data-canvas="container">
        ...
        <div data-off-canvas="mobile-slidebar left overlay">
            <ul class="yamm nav navbar-nav">
               <li><a href="http://www.pct.com/index.html">Home</a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="footer-section">
                                <a class="footer__logo" href="index.html"><img class="img-responsive" src="http://www.pct.com/assets/media/general/logo-lg2.png" alt="Logo"></a>
                            </div>
                        </div>
                        <div class="col-sm-4">
