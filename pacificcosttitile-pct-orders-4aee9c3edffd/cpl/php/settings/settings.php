<?php
	...
	------------------------------------------------------ */
	$receiver_email = "ghernandez@pct.com";
	...
	----------------------------------------------------------------------------- */	
	$redirectForm = true;
	$redirectForm_url = "http://www.pct.com/order/order-submitted.html";
	
	/* Powered BY
	 * You will use both your website NAME and URL
	 * By default its powered by SMARTFORMS - http://www.doptiq.com/smart-forms
	----------------------------------------------------------------------------- */
	$poweredby_name = "Pacific Coast Title Company";
	$poweredby_url = "http://www.pct.com";	
