                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p> Hello,<br>
														we have received your CPL request and will begin processing it immediately. 
														Below are the details of your submission. </p>
														
														<p style="border-bottom:1px solid #D8D8D8; height:0; color:#666;text-align:center;padding:15px 0 0 0"></p>
														<p style="margin-top:20px;"> <p><span style="font-weight:bold;font-size:16px">Order Number:</span> '.$OrderNumber.'</p>
														...
														<p><span style="font-weight:bold;font-size:16px">Email To::</span> '.$EmailTo.'</p></p>
