...
final class UpdateCommissionCalculationSPWithFiledsChange extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
		...
		DECLARE order_details_cur
				CURSOR FOR 
					SELECT order_details.prod_type,order_details.underwriter,order_details.premium,REPLACE(order_details.loan_amount, ',', '') as loan_amount,REPLACE(order_details.sales_amount, ',', '') as sales_amount,customer_basic_details.commission_draw_value,order_details.escrow_amount
					FROM order_details
