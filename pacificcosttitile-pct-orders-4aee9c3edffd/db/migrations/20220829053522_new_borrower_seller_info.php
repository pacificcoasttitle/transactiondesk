...
final class NewBorrowerSellerInfo extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table->rename('pct_order_borrower_seller_packet_info')->update();
        ...
        $table->addColumn('order_id', 'integer')
            ...
            ->addColumn('is_main_seller', 'boolean', ['null' => true, 'default' => 0])
			->addColumn('marital_status', 'string', [ 'null' => true])
            ->addColumn('married_to', 'integer', [ 'null' => true])
			->addTimestamps()
            ->create();
    }
}
